...
export const fetchResearchSessions = createAsyncThunk(
  "researchAssisstant/fetchResearchSessions",
...
export const createResearchSession = createAsyncThunk(
  "researchAssisstant/createResearchSession",
...
export const retrieveResearchSession = createAsyncThunk(
  "researchAssisstant/retrieveResearchSession",
...
export const sendResearchMessage = createAsyncThunk(
  "researchAssisstant/sendResearchMessage",
...
export const fetchResearchMessages = createAsyncThunk(
  "researchAssisstant/fetchResearchMessages",
  async (sessionId, { rejectWithValue }) => {
    try {
      const token = await AsyncStorage.getItem("access");
...
export const deleteResearchSession = createAsyncThunk(
  "researchAssisstant/deleteResearchSession",
  async (sessionId, { rejectWithValue }) => {
    try {
      const token = await AsyncStorage.getItem("access");
      if (!token) return rejectWithValue("No auth token found");
...
const researchAssisstantSlice = createSlice({
  name: "researchAssisstant",
  initialState: {
    sessionId: null,
    sessions: [],
    messages: [],
...
export const { 
  ...
  clearMessages, 
  setSessionActive 
} = researchAssisstantSlice.actions;
export default researchAssisstantSlice.reducer;